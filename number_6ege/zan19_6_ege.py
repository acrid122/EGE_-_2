...
#при выведении холста на экран все отцентрировано относительно начала координат
tracer(0)
lt(90) #всегда поворачиваем черепашку, чтобы она смотрела вдоль оси ординат
m = 20
